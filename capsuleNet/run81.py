...
from capsuleNet.rc_model81 import RCModel
...
def parse_args():
    ...
    parser.add_argument('--input', default="../data/devset/dev_mini.json",
                        help='input path')
    ...
    path_settings.add_argument('--test_files', nargs='+',
                               default=['../data/v81/testset/test_pre.json'],
                               help='list of files that contain the preprocessed test data')
    path_settings.add_argument('--vocab_dir', default='../data/v81/vocab/',
                               help='the dir to save vocabulary')
    path_settings.add_argument('--model_dir', default='../data/v81/models/',
                               help='the dir to store models')
    path_settings.add_argument('--result_dir', default='../data/v81/results/',
                               help='the dir to output the results')
    path_settings.add_argument('--summary_dir', default='../data/v81/summary/',
                               help='the dir to write tensorboard summary')
    path_settings.add_argument('--log_path', default='../data/v81/logging2',
...
def evaluate(args):
    ...
    dev_loss = rc_model.evaluate(dev_batches, result_dir=args.result_dir, result_prefix='valid_v81')
...
def predict(args):
    ...
    rc_model.evaluate(test_batches,
                      result_dir=args.result_dir, result_prefix='test_v81')
...
def run():
    ...
    if args.mode == "dev":
        ...
        prepro(args.input, 2, '../data/v81/testset/test_pre.json')
        args.predict = True
    elif args.mode == "prepro":
        args.prepare = True
        prepro(args.input, 3, '../data/v81/testset/test_pre.json')
